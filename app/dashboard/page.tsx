    ...
    >
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-4">
            {projects.slice(0, 5).map((project) => (
              <article key={project._id} className="rounded-xl border border-slate-100 bg-gray-50/60 p-4">
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 space-y-4">
            {dprs.slice(0, 5).map((dpr) => (
              <article key={dpr._id} className="rounded-xl border border-slate-100 bg-gray-50/60 p-4">
      ...
      <section className="mt-10 rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
        <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          ...
          <div className="inline-flex items-center gap-2 rounded-full bg-gray-100 px-3 py-1 text-xs font-medium text-slate-600">
        ...
        <div className="mt-6 grid grid-cols-1 gap-4 md:grid-cols-2 lg:grid-cols-3">
          {kpis.slice(0, 6).map((kpi) => {
            ...
            return (
              <article key={kpi._id} className="rounded-xl border border-slate-100 bg-gray-50/60 p-4">
                <div className="flex items-start justify-between">
                  <div>
