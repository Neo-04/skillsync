    ...
    >
        ...
        <section className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm">
          ...
          <div className="mt-4 flex justify-end gap-3">
            <button
              ...
              className="rounded-xl border border-slate-200 px-4 py-2 text-sm font-semibold text-slate-500 hover:border-slate-300 hover:bg-slate-100"
            >
              Clear
            </button>
            <button
      ...
      >
        <textarea
          ...
          rows={16}
          className="h-72 w-full rounded-xl border border-slate-200 bg-slate-50 px-4 py-3 text-sm focus:border-blue-400 focus:outline-none focus:ring-2 focus:ring-blue-100"
        />
      </Modal>
    </AppShell>
  );
